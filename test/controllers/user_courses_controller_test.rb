...
class UserCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_course" do
    assert_difference('UserCourse.count') do
      post user_courses_url, params: { user_course: { course_id: @user_course.course_id, status: @user_course.status, user_id: @user_course.user_id } }
    end
  ...
  test "should update user_course" do
    patch user_course_url(@user_course), params: { user_course: { course_id: @user_course.course_id, status: @user_course.status, user_id: @user_course.user_id } }
